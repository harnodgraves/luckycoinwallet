    ...
    <div className={className}>
      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className={`relative mt-1 w-full`}>
          <ListboxButton className="relative w-full cursor-default rounded-xl bg-input-bg py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-green-300 sm:text-sm">
